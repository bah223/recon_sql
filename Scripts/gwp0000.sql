...
WITH selected_partners AS (
    ...
    WHERE id IN (
        ...
        3038, 4039, 3953, 3954, 3956, 4000, 4192, 4211, 4202, 4276, -- Термокит или нет у нас в таблице или еще чего
...
params AS (
    SELECT 
        '2026-01-30'::date as date1,  -- Дата1 (полные сутки)
        '2026-02-06'::date as date2   -- Дата2 (полные сутки)
),
