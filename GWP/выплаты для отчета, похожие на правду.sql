WITH params AS (
    SELECT 
        '2026-01-08 20:59:00'::timestamp as period1_start,
        '2026-01-09 21:00:00'::timestamp as period1_end,
        '2026-01-15 20:59:00'::timestamp as period2_start,
        '2026-01-16 21:00:00'::timestamp as period2_end
),
selected_ids AS (
...
SELECT
    ...
    COALESCE(period1.cnt, 0) AS "09.01.2026",
    COALESCE(period2.cnt, 0) AS "16.01.2026",
...
ORDER BY "16.01.2026" DESC, "Мерчант";