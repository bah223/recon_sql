...
params AS (
    SELECT 
        '2026-01-10'::date as date1,  -- Первая дата (00:00-12:00)
        '2026-01-17'::date as date2   -- Вторая дата (00:00-12:00)
),
...
SELECT
    ...
    total_date1 AS "Создано транзакций (дата1 00:00-12:00)",
    total_date2 AS "Создано транзакций (дата2 00:00-12:00)",
    diff AS "Δ (абс.)",
    CASE
